...
class Jstagestudent extends StatefulWidget {
  final String studentId;

  Jstagestudent({required this.studentId});

  @override
  _JstagestudentState createState() => _JstagestudentState();
}

class _JstagestudentState extends State<Jstagestudent> {
  ...
  Future<void> _loadPdf() async {
    ...
    try {
      ...
      String filePath = await apiService.downloadStudentPdf(widget.studentId); // Adjusted API method name
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Journal Stage PDF Viewer'),
